...
#
# Plot a map from XY = a table of Cartesian coordinates. On the map, 
# draw lines corresponding to values below a distance threshold
# or below a threshold value in D.mat.
# 
# XY could be the result of a PCoA of matrix D.mat. 
# To achieve that, activate the following line:
#    XY = cmdscale(as.dist(D.mat))
# Place it after { at the beginning of the function and provide a distance matrix D.mat.
#
# Parameters:
#
